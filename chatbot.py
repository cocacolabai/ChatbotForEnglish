...
def create_model(session, forward_only, beam_search, beam_size = 5):
    ...
    model_path = '/home/liup/code/seq2seq_chatbot-master/tmp/chat_bot.ckpt-0'
    if forward_only:
...
def train():
    # prepare dataset
    data_path = '/home/liup/code/seq2seq_chatbot-master/data/dataset-cornell-length10-filter1-vocabSize40000.pkl'
